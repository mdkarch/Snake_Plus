...
entity de2_audio_0 is
	port (
		...
		AUD_ADCLRCK : out   std_logic;                                        --    conduit_end.export
		AUD_ADCDAT  : in    std_logic                     := '0';             --               .export
...
end entity de2_audio_0;

architecture rtl of de2_audio_0 is
	component de2_audio is
		port (
	...
	end component de2_audio;

begin

	de2_audio_0 : component de2_audio
		port map (
			clk         => clk,         --          clock.clk
...
end architecture rtl; -- of de2_audio_0
